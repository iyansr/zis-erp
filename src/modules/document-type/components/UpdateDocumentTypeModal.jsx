...
import useMutateUdpateDocumentType from '../hooks/useMutateUdpateDocumentType';
...
const UpdateDocumentTypeModal = ({ data }) => {
  ...
  const { mutateAsync, isPending } = useMutateUdpateDocumentType();
  ...
  return (
    <>
      ...
      >
        <EditIcon className="h-3 w-3" /> Edit Tipe Dokumen
      </button>
        ...
        <div className="modal-box">
          <div className="flex items-center border-b pb-2">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-lg ">Ubah Tipe Dokumen</h3>
            </div>
